...
const DropdownMenu: React.FC = () => {
    ...
    return (
        <div className="relative font-work">
            <div
                className="flex items-center justify-between h-9 w-32 border border-gray-300 rounded-md px-3 py-2 cursor-pointer"
            ...
            >
                ...
                <svg
                    ...
                    className={`h-5 w-5 text-gray-500 transform ${isOpen ? 'rotate-180' : 'rotate-0'} transition-all`}
                    viewBox="0 0 20 20"
                    fill="currentColor"
                >
                    <path
