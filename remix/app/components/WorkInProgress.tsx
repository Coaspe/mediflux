...
const WorkInProgress: React.FC<WorkInProgressProps> = ({ message }) => {
  return (
    <div className="flex flex-col items-center justify-center w-full h-full max-w-[700px] max-h-[400px] p-6 bg-red-100 border border-red-300 rounded-lg text-red-800">
